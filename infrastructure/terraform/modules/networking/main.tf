...
resource "azurerm_subnet" "bastion" {
  ...
  resource_group_name  = var.resource_group_name
  virtual_network_name = azurerm_virtual_network.main.name
  address_prefixes     = ["10.0.6.0/26"]  # Minimum /26 for Bastion
}
...
resource "azurerm_network_security_group" "apim" {
  ...
  # APIM requires specific rules for management
  security_rule {
  ...
  security_rule {
    ...
    source_address_prefix      = var.allowed_ip_ranges != [] ? join(",", var.allowed_ip_ranges) : "VirtualNetwork"
